  ...
  return (
    <header className="sticky top-0 z-30 border-b border-[#DED6CD]/70 bg-[#F4EFE9]/90 px-4 py-3 backdrop-blur-2xl sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-[1540px] items-center gap-3">
        ...
        {isPreview ? (
          <div className="hidden h-10 items-center gap-2 rounded-full border border-[#B88A55]/25 bg-[#B88A55]/10 px-4 text-[9px] font-semibold uppercase tracking-[0.2em] text-[#8D6235] sm:flex">
            <ShieldCheck size={14} />
            Preview
          </div>
        ) : null}
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="space-y-1 p-2">
              {[
                isPreview
                  ? "Preview mode is safely read only."
